...
var Location = function (_React$Component) {
  ...
  function Location(props) {
    ...
    _this.onAutocomplete = _this.onAutocomplete.bind(_this);
    return _this;
  }
  ...
  _createClass(Location, [{
    ...
    value: function locationString() {
      return [this.props.activity.street, this.props.activity.city, this.props.activity.state, this.props.activity.country].filter(function (value) {
