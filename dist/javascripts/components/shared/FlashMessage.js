...
var FlashMessage = function (_Component) {
  ...
  function FlashMessage(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FlashMessage).call(this, props));
  ...
  _createClass(FlashMessage, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "flash text-center flash--" + this.props.status },
        _react2.default.createElement(
          "a",
          { className: "flash__close", href: "#", onClick: this.onClickClose },
