...
module.exports = {
  init: function(alt, actions, resource, displayName) {
    ...
    SimpleStore.prototype.removeObject = function(object) {
      this.setObjects(
        this[resource].filter(function(object2) {
    ...
    SimpleStore.prototype.setAttributesChanged = function(hash) {
      this[`${singular}_attributes_changed`] = Object.assign(
        this[`${singular}_attributes_changed`], hash
      );
    };
